...
namespace Ejercicio_ActividadSemanal_0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Ingrese la Base del terreno rectangular:");double baserec = double.Parse(Console.ReadLine());
            Console.WriteLine("Ingrese la altura del terreno rectangular");double altura = double.Parse(Console.ReadLine());
